...
def normalise_input(user_input):
    ...
    text_no_space = remove_spaces(text_no_punct)
...
def menu(exits):
    ...
    while True:
        ...
        print_menu(exits)
        user_input = input()
        user_input_normalised = normalise_input(user_input)

        if is_valid_exit(exits, user_input_normalised):
